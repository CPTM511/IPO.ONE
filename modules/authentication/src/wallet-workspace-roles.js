...
export const INVITED_WALLET_ROLES = Object.freeze(["capital_partner_operator", "risk_operator", "operations_operator", "auditor"]);
export const WALLET_ROLE_LABELS = Object.freeze({
  ...
  operations_operator: "Servicing Operations",
  auditor: "Auditor"
});
