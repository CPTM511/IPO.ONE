...
export const CreditEventType = Object.freeze({
  ...
  PILOT_CASE_FILED: "pilot_case_filed",
  PILOT_CASE_ASSIGNED: "pilot_case_assigned",
  PILOT_CASE_RESOLVED: "pilot_case_resolved",
  CREDIT_PASSPORT_ARTIFACT_ISSUED: "credit_passport_artifact_issued",
  CREDIT_PASSPORT_ARTIFACT_SUPERSEDED: "credit_passport_artifact_superseded",
  CREDIT_PASSPORT_ARTIFACT_REVOKED: "credit_passport_artifact_revoked",
  OFFICIAL_REPORT_ARTIFACT_ISSUED: "official_report_artifact_issued",
  OFFICIAL_REPORT_ARTIFACT_REVOKED: "official_report_artifact_revoked",
  TRADING_ACCOUNT_BINDING_CHALLENGE_CREATED: "trading_account_binding_challenge_created",
  TRADING_SYNTHETIC_HISTORY_IMPORTED: "trading_synthetic_history_imported",
  TRADING_HYPERLIQUID_HISTORY_IMPORTED: "trading_hyperliquid_history_imported",
  TRADING_EVIDENCE_SNAPSHOT_FINALIZED: "trading_evidence_snapshot_finalized",
  TRADING_CAPITAL_REQUEST_CREATED: "trading_capital_request_created",
  TRADING_PROVIDER_MANDATE_CREATED: "trading_provider_mandate_created",
  TRADING_MATCH_PROPOSAL_CREATED: "trading_match_proposal_created",
  TRADING_MATCH_PROVIDER_ACCEPTED: "trading_match_provider_accepted",
  TRADING_MATCH_SUBJECT_ACCEPTED: "trading_match_subject_accepted",
  TRADING_FACILITY_CREATED: "trading_facility_created",
  TRADING_FACILITY_SUBJECT_COLLATERAL_RECORDED:
    "trading_facility_subject_collateral_recorded",
  ...
  TRADING_FACILITY_NEW_RISK_PAUSED: "trading_facility_new_risk_paused",
  TRADING_FACILITY_FLATTENED: "trading_facility_flattened",
  TRADING_FACILITY_CLOSE_REQUESTED: "trading_facility_close_requested",
