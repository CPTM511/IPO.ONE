...
4. `DATA-003` (foundation, DATA-003A, DATA-003B, DATA-003C, and DATA-003D complete locally;
   ...
   preserving the anonymous public sandbox boundary. Detailed risk drill-down,
   alerts, exports, and every economic lifecycle operation remain separate work.
