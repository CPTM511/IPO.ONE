-- Downgrade is only allowed before special-role data exists; no history is deleted.
...
ALTER TABLE authentication_passkey_challenges ADD CONSTRAINT authentication_passkey_challenges_origin_check CHECK (origin IN ('http://localhost:8937','http://localhost:8947'));
