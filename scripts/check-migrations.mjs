...
for (const required of [
  ...
  "memberships_authorization_transition_guard",
  "actors_authorization_lock",
  ...
  "authorization_resources_transition_guard",
  "authorization_resource_bindings_transition_guard",
  ...
  "live_chain_observations_immutable",
  "live_chain_indexer_snapshots_immutable",
  "live_chain_outbox_messages_transition_guard",
  "credit_registry_chain_observations_immutable",
  "credit_registry_chain_outbox_transition_guard",
  "pool_chain_observations_immutable",
  "pool_chain_cursors_immutable",
  "pool_chain_finalized_effects_immutable",
  "pool_chain_outbox_messages_immutable",
  "pool_reconciliation_runs_immutable",
  "pool_reconciliation_discrepancies_immutable",
  "pool_reconciliation_evidence_immutable",
  "pool_risk_controls_immutable",
  "pool_risk_control_transitions_immutable",
  ...
  "credit_outcomes_immutable_guard",
  "tenant_command_pauses_immutable_guard",
  "credit_intents_projection_guard",
  "credit_offers_projection_guard",
  "consent_records_projection_guard",
  "human_identity_references_projection_guard",
  "human_identity_references_consent_guard",
